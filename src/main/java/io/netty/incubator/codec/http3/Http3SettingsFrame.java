...
public interface Http3SettingsFrame extends Http3ControlStreamFrame, Iterable<Map.Entry<Long, Long>> {
  ...
  /**
   * See <a href=
   * "https://tools.ietf.org/html/draft-ietf-quic-http-32#section-7.2.4.1">
   ...
   * @return the value of the setting or {@code null} if none was found with the
   *         given key.
   */
  Long get(long key);
   ...
   * @return the value of the setting or {@code defaultValue} if none was found
   *         with the given key.
   */
   ...
   * @return the previous stored valued for the given key or {@code null} if none
   *         was stored before.
   */
