...
public interface Http3Headers extends Headers<CharSequence, CharSequence, Http3Headers> {
  ...
  enum PseudoHeaderName {
     ...
     * @return {@code true} if the given header name is a valid HTTP/3 pseudo
  ...
  /**
   * Returns an iterator over all HTTP/3 headers. The iteration order is as
   * follows:
   ...
   *                        compare values.
   *                        otherwise a case sensitive compare is run to compare
   *                        values.
