...
public class Http3ClientConnectionHandler extends Http3ConnectionHandler {
   ...
   *                                           interested in these.
   * @param pushStreamHandlerFactory           the {@link LongFunction} that will
   *                                           provide a custom
   *                                           {@link ChannelHandler} for push
   *                                           streams {@code null} if no special
   *                                           handling should be done. When
   *                                           present, push ID will be passed as
   *                                           an
   *                                           argument to the
   *                                           {@link LongFunction}.
